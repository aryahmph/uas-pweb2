    ...
    <div class="container mx-auto">
        <div class="row mx-auto">
            <div class="col-12 text-center mt-5">
                <img src="uploads/<?= $data["image_url"] ?>" class="profile-img" alt="profile-image">
            </div>
            <div class="col-12 text-center mt-4">
                ...
                <div class="icon mt-4">
                    <a href="<?= $data["github_url"] ?>" target="_blank">
                        <img src="resources/logos_github-icon.png" alt="github">
                    </a>
                    <a href="<?= $data["linkedin_url"] ?>" target="_blank">
                        <img src="resources/logos_linkedin-icon.png" alt="linkedin">
                    </a>
                    <a href="<?= $data["whatsapp_url"] ?>" target="_blank">
                        <img src="resources/logos_whatsapp.png" alt="whatsapp">
                    </a>
                </div>
            ...
            <div class="col-8 mx-auto">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <?php if (is_null($data["university"]) || is_null($data["major"])) { ?>
                            <p class="p-3">Please complete your profile in update profile</p>
                        <?php } else { ?>
                            <p class="p-3">
                                Hello, my name is <b><?= $data["name"] ?></b>, studying at <b><?= $data["university"] ?></b>, majoring in <b><?= $data["major"] ?></b>.
                                <br> Nice to meet yaa !
                            </p>
                        <?php } ?>
                    </div>
                    ...
                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                        ...
                        <ul>
                            ...
                            <?php } else { ?>
                                ...
                                <li>LinkedIn : <?= $data["linkedin_account"] ?></li>
                                <li>GitHub : <?= $data["github_account"] ?></li>
                                <li>Whatsapp : <?= $data["whatsapp_account"] ?></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
